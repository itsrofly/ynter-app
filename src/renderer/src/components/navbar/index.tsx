...
export default function Navbar() {
    ...
    return (
        <>
            <div className="top-bar ms-3 mt-2">
                ...
                <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
                ...
                {/* Offcanva navbar */}
                <div className="offcanvas offcanvas-start border-end border-2 border-primary" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel"
                    style={{ width: "60px", height: "100vh" }}>

                    <nav className="navbar d-flex flex-column h-100">
                        <div className="mt-5 d-flex flex-column gap-4">
                            <NavLink className="nav-link rounded d-flex" to="/"
                                style={({ isActive }) => {
                                    return {
                            ...
                            <NavLink className="nav-link rounded d-flex" to="revenue"
                                style={({ isActive }) => {
                                    return {
                                        backgroundColor: isActive ? "rgba(217, 217, 217, 0.80)" : "transparent",
                                        borderColor: isActive ? "black" : "transparent",
                            ...
                            <NavLink className="nav-link rounded d-flex" to="expenses"
                                style={({ isActive }) => {
                                    return {
                                        backgroundColor: isActive ? "rgba(217, 217, 217, 0.80)" : "transparent",
                                        borderColor: isActive ? "black" : "transparent",
                            ...
                            <NavLink className="nav-link rounded d-flex" to="agenda"
                                style={({ isActive }) => {
                                    return {
                                        backgroundColor: isActive ? "rgba(217, 217, 217, 0.80)" : "transparent",
                                        borderColor: isActive ? "black" : "transparent",
                            ...
                            <NavLink className="nav-link rounded d-flex" to="notes"
                                style={({ isActive }) => {
                                    return {
                                        backgroundColor: isActive ? "rgba(217, 217, 217, 0.80)" : "transparent",
                                        borderColor: isActive ? "black" : "transparent",
                        ...
                        <div className="mt-auto mb-5">
                            {!localStorage.getItem("user:email") ?
                                <div data-bs-toggle="modal" data-bs-target="#loginStaticBackDrop" style={{ cursor: "pointer" }}>
            ...
            {/* Navbar */}
            <nav className="navbar left-bar border-end border-2 border-primary
                d-flex flex-column" style={{width: "60px"}}>
                <div className="mt-5 d-flex flex-column gap-4">
                    {/* Tabs */}
                    <NavLink className="nav-link rounded d-flex" to="/"
                        style={({ isActive }) => {
            ...
            <form onSubmit={async (e) => {
                ...
                <div className="modal fade position-absolute" id="loginStaticBackDrop" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="loginStaticBackDropLabel" aria-hidden="true">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="d-flex flex-column h-50 align-items-center w-100 gap-3 p-5">
                                    ...
                                    <input type="email" name="email" className="form-control border border-2" id="FormControlInput1" placeholder="Email"
                                        style={{ width: "300px" }} required
                                        value={email} onChange={(ev: any) => setEmail(ev.target.value)} />

                                    <button className="btn border border-2" type="submit" disabled={isLoading}
                                        style={{ width: "300px" }}>
                                        {isLoading && <span className="spinner-grow spinner-grow-sm" aria-hidden="true" />}
                            ...
                            <div className="modal-footer d-flex flex-column justify-content-center">
                                <div className="d-flex justify-content-between" style={{ width: "225px" }}>
                                    <a className="nav-link" href={WEBSITE + "/Privacy"} target="_blank" style={{ display: "inline" }}>
                                        <h6 style={{ display: "inline" }}>Privacy Policy</h6>
                                    </a>
                                    <a className="nav-link" href={WEBSITE + "/Terms"} target="_blank" style={{ display: "inline" }}>
