...
import {
  ...
  XAxis, YAxis, Tooltip, Line, BarChart, Bar
} from "recharts";
...
export const CustomIconExpenses = (props: { width: string, height: string, x?: number, y?: number, payload: { value: string | number } }) => {
  ...
  switch (payload.value) {
    case 'Home':
      return (
        <svg x={x - 12} y={y} xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width} fill="#FFFFFF">
    ...
    case 'Travel':
      return (
        <svg x={x - 12} y={y} xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width} fill="#FFFFFF"><path d="M340-80v-60l80-60v-220L80-320v-80l340-200v-220q0-25 17.5-42.5T480-880q25 0 42.5 17.5T540-820v220l340 200v80L540-420v220l80 60v60l-140-40-140 40Z" /></svg>
      )
    case 'Entertainment':
      return (
        <svg x={x - 12} y={y} xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width} fill="#FFFFFF"><path d="M182-200q-51 0-79-35.5T82-322l42-300q9-60 53.5-99T282-760h396q60 0 104.5 39t53.5 99l42 300q7 51-21 86.5T778-200q-21 0-39-7.5T706-230l-90-90H344l-90 90q-15 15-33 22.5t-39 7.5Zm16-86 114-114h336l114 114q2 2 16 6 11 0 17.5-6.5T800-304l-44-308q-4-29-26-48.5T678-680H282q-30 0-52 19.5T204-612l-44 308q-2 11 4.5 17.5T182-280q2 0 16-6Zm482-154q17 0 28.5-11.5T720-480q0-17-11.5-28.5T680-520q-17 0-28.5 11.5T640-480q0 17 11.5 28.5T680-440Zm-80-120q17 0 28.5-11.5T640-600q0-17-11.5-28.5T600-640q-17 0-28.5 11.5T560-600q0 17 11.5 28.5T600-560ZM310-440h60v-70h70v-60h-70v-70h-60v70h-70v60h70v70Zm170-40Z" /></svg>
      )
    case 'Shopping':
      return (
        <svg x={x - 12} y={y} xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width} fill="#FFFFFF"><path d="M240-80q-33 0-56.5-23.5T160-160v-480q0-33 23.5-56.5T240-720h80q0-66 47-113t113-47q66 0 113 47t47 113h80q33 0 56.5 23.5T800-640v480q0 33-23.5 56.5T720-80H240Zm0-80h480v-480h-80v80q0 17-11.5 28.5T600-520q-17 0-28.5-11.5T560-560v-80H400v80q0 17-11.5 28.5T360-520q-17 0-28.5-11.5T320-560v-80h-80v480Zm160-560h160q0-33-23.5-56.5T480-800q-33 0-56.5 23.5T400-720ZM240-160v-480 480Z" /></svg>
      )
    case 'Investments':
      return (
...
const ExpensesCategory = (index: number) => {
  switch (index) {
    case 0:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Home" } }), Label: 'Home' };
    case 1:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Food" } }), Label: 'Food' };
    case 2:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Education" } }), Label: 'Education' };
    case 3:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Health" } }), Label: 'Health' };
    case 4:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Bills" } }), Label: 'Bills' };
    case 5:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Transport" } }), Label: 'Transport' };
    case 6:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Travel" } }), Label: 'Travel' };
    case 7:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Entertainment" } }), Label: 'Entertainment' };
    case 8:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Shopping" } }), Label: 'Shopping' };
    case 9:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Investments" } }), Label: 'Investments' };
    case 10:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Savings" } }), Label: 'Savings' };
    case 11:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Family" } }), Label: 'Family' };
    default:
      return { Icon: CustomIconExpenses({ width: "18px", height: "18px", payload: { value: "Others" } }), Label: 'Others' };
  }
}
...
function Expenses() {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      setReceipts(await fetchReceipt(monthReceipt ? "%Y-%m" : "%Y", "expense", dateList, selectedOption))
    };
    fetchBalance();
  ...
  return (
    <div className="right-content-primary">
      <NewReceipt table="expense" handleSubmit={formSubmit ? handleSubmitReceipt : handleUpdateReceipt} refresh={refresh} setRefresh={setRefresh} form={formValue} />
        ...
        <div className="position-relative d-flex flex-column w-100 h-100 bg-white rounded shadow-sm">
          ...
          <div className="mt-auto m-3">
            <div className="d-flex align-items-end justify-content-between h-100">
              ...
              <div>
                <button type="button"
                  className={"btn btn-sm text-center border-0 remove-focus me-2" + (monthExpensesCat ? " secondary text-white" : "")}
                  onClick={() => setMonthExpensesCat(true)}>Month</button>
                <button type="button"
                  className={"btn btn-sm text-center border-0 remove-focus me-2" + (!monthExpensesCat ? " secondary text-white" : "")}
                  onClick={() => setMonthExpensesCat(false)}>Year</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="position-relative d-flex flex-column w-100 h-100 bg-white rounded shadow-sm">
          ...
          <div className="mt-auto m-3">
            <div className="d-flex align-items-end justify-content-between h-100">
              ...
              <div>
                <button type="button"
                  className={"btn btn-sm border-0 remove-focus text-center me-2" + (monthExpenses ? " secondary text-white" : "")}
                    ...
                    {expenses.map((exp, jndex) => {
                      ...
                      return (
                        <div className="col mt-5 mb-1" key={jndex} style={{ height: "150px", width: "300px" }}>
                          <div className="position-relative d-flex flex-column w-100 h-100 bg-white rounded shadow-sm">
                            <div className="shadow z-2 rounded-4 tertiary position-absolute d-flex
