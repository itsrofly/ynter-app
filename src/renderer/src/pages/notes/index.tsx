...
async function handleUpsertAgenda(date: string, title: string, importance: number, id?: number) {
    try {
        const result = await window.api.Database(
            `
...
async function handleAgendaId(id: number, agenda: number) {
    try {
...
async function fetchAgenda(id: number) {
    try {
        const result = await window.api.Database(`
            SELECT * 
            FROM agenda
...
async function handleUpdateData(id: number, data: string) {
    const date = dayjs();
    const date_formatted = date.format("YYYY-MM-DD HH:mm:00");
...
async function handleUpdatePriority(id: number, priority: number, agendaId?: number) {
    const date = dayjs();
    const date_formatted = date.format("YYYY-MM-DD HH:mm:00");
...
async function handleDelete(id: number, delete_row: boolean, agendaId?: number ) {
    if (delete_row) {
        await window.api.Database(
            `DELETE FROM notes WHERE id = ${id};`
        );
        await window.api.Database(
            `DELETE FROM agenda WHERE id = ${agendaId};`
        );
    }
    else
        await window.api.Database(
...
async function fetchNotes(search: string, sort: Sort, filter: Filter | undefined) {
    ...
    const result:
        Note[] = await window.api.Database(query);
    return result;
}

async function fetchNoteData(id: number) {
...
function Notes() {
    ...
    const [titleTimoutId, setTitleTimoutId] = useState<number>();
        ...
        <div className="right-content-secondary">
            ...
            <div className="area-first d-flex flex-column overflow-y-auto border-top">
                        ...
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h1 className="modal-title fs-5" id="staticBackdropLabel">Create</h1>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div className="input-group mb-3">
                                        <span className="input-group-text" id="basic-addon1" style={{ width: "100px" }}>Name</span>
                                        <input type="text" className="form-control" placeholder="To do List" aria-label="Name" aria-describedby="basic-addon1"
                ...
                <div className="w-100 d-flex p-3 justify-content-between" style={{ height: "63px" }}>
                    ...
                    <button type="button" className="btn remove-focus border-0" data-bs-toggle="modal" data-bs-target="#noteModal">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <div className="d-flex gap-2 ps-2 pe-2">
                    <input className="form-control" id="searchNote" type="text" placeholder="Type to search..."
                    ...
                    <div className="dropdown-center">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li><a className={"dropdown-item remove-focus" + (sort.sortby == "updated_date" ? " bg-info-subtle" : "")} href="#"
                                onClick={(e) => {
                                ...
                                Date
                                {sort.sortby == "updated_date" && (sort.up ?
                            ...
                            <li><a className={"dropdown-item remove-focus" + (sort.sortby == "priority" ? " bg-info-subtle" : "")} href="#"
                                onClick={(e) => {
                                    e.preventDefault(); // Prevent click move
                                    setSort({
                                        sortby: "priority",
                            ...
                            <li><a className={"dropdown-item remove-focus" + (sort.sortby == "title" ? " bg-info-subtle" : "")} href="#"
                                onClick={(e) => {
                                    e.preventDefault(); // Prevent click move
                                    setSort({
                                        sortby: "title",
                    ...
                    {/* filter Stuff */}
                    <div className="dropdown-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-filter"
                            type="button" data-bs-toggle="dropdown" aria-expanded="false" viewBox="0 0 16 16">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li className="d-flex text-center">
                                <a className={"dropdown-item remove-focus" + (!filter ? " bg-info-subtle" : "")} href="#"
                                    onClick={(e) => {
                                        e.preventDefault(); // Prevent click move
                                        setFilter(undefined)
                                    }}>
                            ...
                            <li className="d-flex justify-content-center">
                                ...
                                <a className="dropdown-item remove-focus" href="#" style={{
                                    height: "24px",
                                    width: "24px"
                                }}
                                    onClick={(e) => {
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" className={"bi bi-flag-fill" + (filter?.type == "priority" && filter.value == 0 ? " bg-info-subtle" : "")} viewBox="0 0 16 16">
                                ...
                                <a className="dropdown-item remove-focus" href="#" style={{
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" className={"bi bi-flag-fill" + (filter?.type == "priority" && filter.value == 1 ? " bg-info-subtle" : "")} viewBox="0 0 16 16">
                                        <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                                    </svg>
                                </a>
                                ...
                                <a className="dropdown-item remove-focus" href="#" style={{
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className={"bi bi-flag-fill" + (filter?.type == "priority" && filter.value == 2 ? " bg-info-subtle" : "")} viewBox="0 0 16 16">
                                        <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                                    </svg>
                                </a>
                            </li>
                            ...
                            <li className="d-flex text-center">
                                <a className={"dropdown-item remove-focus" + (filter?.type == "trash" ? " bg-info-subtle" : "")} href="#"
                                    onClick={(e) => {
                                        e.preventDefault(); // Prevent click move
                                        setFilter({
                                            type: "trash",
                ...
                <div className="overflow-y-auto">
                    ...
                    {notesList?.map((values, index) => {
                        return <div key={index}
                            className={"d-flex align-items-center border-bottom w-100" + ((id == values.id) ? " bg-info-subtle" : "")}
                            style={{ height: "60px" }}>
                            ...
                            <div className="w-100 h-100 p-3"
                                onClick={async () => {
                                    ...
                                    const res = await fetchNoteData(values.id) as { data: string, agenda: number };
                                    try {
                                ...
                                <div className="ps-4 d-flex w-100 flex-column align-items-start">
                                    ...
                                    <div>
                                        {dayjs(values.updated_date).format("DD/MM")}
                                    </div>

                                </div>
                            </div>

                            <div className="ms-auto pe-3" style={{ cursor: "pointer" }}
                                onClick={async () => {
            ...
            <div className="area-second border-start border-top overflow-y-auto overflow-x-hidden d-flex flex-column">
                {/* Note Editor */}
                {id && <>
                    <div className="w-100 border-bottom d-flex align-items-center" style={{ height: "60px" }}>
                        {/* Title */}
                        <div className="ms-3">
                            <input type="text" value={title}
                                className="fs-5 bg-transparent w-100 position-relative form-control border-0 remove-focus" placeholder="Title" aria-label="Title" aria-describedby="basic-addon1"
                                onChange={
                                    (e) => {
                                        if (!id)
                                            return;
                        ...
                        <div className="dropdown-center ms-5 me-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={priority} className="bi bi-flag-fill" viewBox="0 0 16 16"
                                type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                            </svg>
                            ...
                            <ul className="dropdown-menu">
                                <li className="d-flex justify-content-center">
                                    ...
                                    <a className="dropdown-item remove-focus" href="#" style={{
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" className="bi bi-flag-fill" viewBox="0 0 16 16">
                                            <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                                        </svg>
                                    </a>
                                    ...
                                    <a className="dropdown-item remove-focus" href="#" style={{
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" className="bi bi-flag-fill" viewBox="0 0 16 16">
                                            <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                                        </svg>
                                    </a>
                                    ...
                                    <a className="dropdown-item remove-focus" href="#" style={{
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className="bi bi-flag-fill" viewBox="0 0 16 16">
                                            <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12 12 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A20 20 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a20 20 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                                        </svg>
                                    </a>
                                </li>
                    ...
                    {/* Editor */}
                    <div className="w-100 overflow-y-auto overflow-x-hidden pt-4" style={{paddingLeft: "60px", paddingRight: "60px"}}>
                        <div id="editorjs" />
                    </div>
